...
type FormHelperTextProps = MuiFormHelperTextProps & { error?: boolean; showErrorIcon?: boolean }
...
export const FormHelperText: React.FC<FormHelperTextProps> = ({
 ...
 ...rest
    ...
    return (
        <Stack direction="row" gap={1} alignItems="flex-start" justifyContent="flex-start">
            {error && (
                <Box>
                    <ErrorFieldIcon />
                </Box>
...
export const TextField: React.FC<Props> = ({
    ...
    return (
        <Stack gap={1} {...containerProps}>
            ...
            disabled={disabled}
            sx={{
                backgroundColor: (theme) => (disabled ? theme.palette.grey[200] : 'inherit'),
                ...sx
            }}
            {...rest}
            />
